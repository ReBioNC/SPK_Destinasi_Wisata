"""
Generator Lengkap 38 Provinsi Indonesia untuk Dataset Pariwisata TravelFit.
Memuat seluruh 38 Provinsi, menjamin 50 destinasi per provinsi (total 1.900 baris),
dan mengekspor ke Excel (Dataset_Wisata_38_Provinsi.xlsx) serta CSV.
"""
...
# Registry batch 2: Bali, Nusa Tenggara, Kalimantan, Sulawesi, Maluku, Papua
ADDITIONAL_PROVINCES = [
    ...
    },
    {
        ...
        "pantai": [
            # Sebagai provinsi pedalaman (landlocked), pantai diwakili oleh pasir putih lembah & tepi danau vulkanik spektakuler
...
ALL_38_PROVINCES.extend(ADDITIONAL_PROVINCES)
print(f"Total Provinsi dalam registri: {len(ALL_38_PROVINCES)}")
